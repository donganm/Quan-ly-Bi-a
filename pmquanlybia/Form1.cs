...
namespace pmquanlybia
{
    public partial class Form1 : Form
    {
        ...
        SqlCommand command;
        string str = @"Data Source=DESKTOP-AS5T8FU\SQLEXPRESS01;Initial Catalog=QuanLyBiA;User Id=sa;Password=Anhthidong04+;Trusted_Connection=true;TrustServerCertificate=True";
        ...
        {
            command = connection.CreateCommand();
            command.CommandText = "select * from LoaiBan";
            adapter.SelectCommand = command;
            DataTable tablelb = new DataTable();
            tablelb.Clear();
            adapter.Fill(tablelb);
            dataGridView1.DataSource = tablelb;
        }
        void hienthincc()
        {
            command = connection.CreateCommand();
            ...
            dataGridView2.DataSource = tablencc;
        }
        private void inhoadon(string invoiceId)
        {
            string connectionString = @"Data Source=DESKTOP-AS5T8FU\SQLEXPRESS01;Initial Catalog=QuanLyBiA;User Id=sa;Password=Anhthidong04+;Trusted_Connection=true;TrustServerCertificate=True";
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-AS5T8FU\SQLEXPRESS01;Initial Catalog=QuanLyBiA;User Id=sa;Password=Anhthidong04+;Trusted_Connection=true;TrustServerCertificate=True"))
            {
